 ...
 * in, so callers can use it directly with no translation. Returns `null` if
 * `hwnd` is invalid or DWM can't report its frame (e.g. a custom-framed app).
 */
 ...
 * frame (see `getWindowRect`) exactly matches `rect` — expanding by the
